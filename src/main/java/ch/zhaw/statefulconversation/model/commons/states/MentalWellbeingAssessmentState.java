...
public class MentalWellbeingAssessmentState extends State {
        ...
        private static final String MENTALWELLBEING_TRIGGER = "Analysiere die folgende Konversation und gib true zurück, wenn der Benutzer eindeutig signalisiert hat, dass er keine weiteren Gesprächsthemen wünscht. Zum Beispiel könnte der Benutzer sagen: 'Ich habe keine weiteren Themen zu besprechen' oder 'Ich denke, das ist alles, worüber ich sprechen will.' Andernfalls gib false zurück. Beachte, dass es notwendig ist, dass der Benutzer klar und direkt ausdrückt, dass er keine weiteren Gesprächsthemen wünscht, damit 'true' zurückgegeben wird.";
